...
export function SidebarItemsTeacher(){
    ...
    return (
        <div className="sidebar-content-items">
            ...
            <SidebarItem2 icon={"pi pi-receipt"} title={"Transacciones"} textColor={textColor} backgroundAccentColor={backgroundAccentColor} textAccentColor={textAccentColor} onClick={() => router.push("/transaction-teacher")}/>
