...
export function SidebarItemsTeacher(){
    ...
    return (
        <div className="sidebar-content-items">
            ...
            <SidebarItem2 icon={"pi pi-video"} title={"Videoconferencias"} textColor={textColor} backgroundAccentColor={backgroundAccentColor} textAccentColor={textAccentColor} onClick={() => router.push("/conference-list")}/>    
