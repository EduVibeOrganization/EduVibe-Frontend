...
export function SidebarItemsTeacher(){
    ...
    return (
        <div className="sidebar-content-items">
            ...
            <SidebarItem2 icon={"pi pi-book"} title={"Crear Curso"} textColor={textColor} backgroundAccentColor={backgroundAccentColor} textAccentColor={textAccentColor} onClick={() => router.push("/create-course")}/>
            <SidebarItem2 icon={"pi pi-video"} title={"Crear Videoconferencia"} textColor={textColor} backgroundAccentColor={backgroundAccentColor} textAccentColor={textAccentColor} onClick={() => router.push("/conference-creation")}/> 
