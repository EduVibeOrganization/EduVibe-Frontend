        ...
        <div className="bg-sky-400 page-size">
           <div className="flex justify-center items-center ">
                 ...
                 <div className="flex flex-col justify-center items-center mt-10 gap-5 lg:ml-96">
                   ...
                   <CustomInputText value="" placeHolder={"Nombre de usuario"} onChange={(e) => console.log(e)} hasBorder={false}/> 
                   <CustomInputText value="" placeHolder={"Número de telefono"} onChange={(e) => console.log(e)} hasBorder={false}/> 
